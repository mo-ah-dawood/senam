...
// import 'package:senam/models/providerModel.dart';
...
// //         "https://atele.sa3d01.com/api/v1/article?article_category_id=$category",
...
// //     http.Response response = await http.get(
// //         "https://atele.sa3d01.com/api/v1/article/categories",
// //         headers: {
// //           "apiToken": "sa3d01${bloc.currentUser().apiToken}",
// //           "lang": bloc.lang() ?? "ar"
// //         });
...
// //   if(loading!=null)
// //   loading.show();
// //   http.Response response = await http.post("https://atele.sa3d01.com/api/v1/article/comment",  headers: {
// //     "apiToken":"sa3d01${bloc.currentUser().apiToken}",
// //     // "lang": bloc.lang() ?? "ar"
// //   },
// //   body: {
