...
//   http.Response response = await http.post("https://atele.sa3d01.com/api/v1/order", body: {
...
//   http.Response response = await http.post("https://atele.sa3d01.com/api/v1/order/$id", body: {
//    "count":count.toString(),
//    "note":note??"",
//   }, headers: {
//     "apiToken":"sa3d01${bloc.currentUser().apiToken}",
...
//  try{ http.Response response =await http.get("https://atele.sa3d01.com/api/v1/order/$status",headers: {
//     "apiToken":"sa3d01${bloc.currentUser().apiToken}"
//   });
...
//   if(loading!=null)
//   loading.show();
//   http.Response response = await http.post("https://atele.sa3d01.com/api/v1/order/$id/accept",  headers: {
//     "apiToken":"sa3d01${bloc.currentUser().apiToken}",
//     "lang": bloc.lang() ?? "ar"
//   });
//   final createdJson = json.decode(response.body);
...
//   http.Response response = await http.post("https://atele.sa3d01.com/api/v1/order/${id.toString()}/cancel",body: {
