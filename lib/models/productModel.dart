...
// class Product {
//   final serviceURL = "https://atele.sa3d01.com/api/v1/product/";
//   int status;
//   int id;
//   String title;
//   String price;
...
//       Uri.parse("https://atele.sa3d01.com/api/v1/product/upload_images"))
//     ..headers.addAll({
...
//         .post("https://atele.sa3d01.com/api/v1/product", body: body, headers: {
//       "apiToken": "sa3d01${bloc.currentUser().apiToken}",
//       "lang": bloc.lang() ?? "ar"
//     });
...
//         "https://atele.sa3d01.com/api/v1/product/$id",
//         body: body,
...
//       await http.get("https://atele.sa3d01.com/api/v1/used_products");
//   final productJson = json.decode(response.body);
